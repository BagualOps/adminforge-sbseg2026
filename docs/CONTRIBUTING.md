...
A suíte cobre 59 cenários: unitários por componente + fluxo end-to-end + edge cases (N membros com vírgula/espaço, completers, audit estendido, permission CRUD, `apply --diff` / `apply verify`, sudo profiles).
